...
// Define types based on fal-ai/recraft/v3 API documentation
...
// Define input schema types for Recraft V3
interface ImageSize {
  width: number;
  height: number;
}
...
type StyleEnum = 
  ...
  | "vector_illustration/engraving_bw"
  | "vector_illustration/line_art"
  | "vector_illustration/line_circuit"
  | "vector_illustration/linocut";

// Recraft V3 ImageSize enum
type ImageSizeEnum = 
  | "1024x1024"
  | "1365x1024"
  | "1024x1365"
...
server.tool(
  ...
  async (args: any) => {
    ...
    try {
      ...
      if (colors && colors.length > 0) input.colors = colors;
      if (style_id) input.style_id = style_id;
      ...
      const output = result.data as RecraftImageResult;
